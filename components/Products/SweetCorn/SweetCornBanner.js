  ...
  return (
   ...
   >
     ...
     <div className="lg:mt-10 flex items-center justify-center flex-col w-full mt-0 !z-[999] px-5">
       <h3 className="text-3xl text-center lg:text-5xl text-white relative z-0 mx-auto font-bold tracking-wider">Pre Cooked Sweet Corn</h3>
...
export default SweetCornBanner